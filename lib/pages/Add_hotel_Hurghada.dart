...
class ADDHotelHurghada extends StatelessWidget {
  ADDHotelHurghada({super.key});
  ...
  CollectionReference hotel = FirebaseFirestore.instance.collection('hotel_Hurghada');
  Future<void> addUser() {
    return hotel
        .doc(namehotel.text)
        .set({
