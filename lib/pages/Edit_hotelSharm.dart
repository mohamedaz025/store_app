// ignore_for_file: sort_child_properties_last, unnecessary_string_interpolations, must_be_immutable, non_constant_identifier_names, file_names

import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';
import 'package:store_app/shared/contants.dart';

class EditdetailsSharm extends StatefulWidget {
  String hotelname;
  String link_img1;
  String link_img_2;
  String stars;
  ...
  @override
  State<EditdetailsSharm> createState() => _EditdetailsSharmState();
}

class _EditdetailsSharmState extends State<EditdetailsSharm> {
          ...
          ElevatedButton(
            onPressed: () {
              CollectionReference edithotel =
                  FirebaseFirestore.instance.collection('hotel_Sharm');
