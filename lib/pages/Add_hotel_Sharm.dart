...
class AddHotel_Sharm extends StatelessWidget {
  AddHotel_Sharm({super.key});
  ...
  CollectionReference hotel = FirebaseFirestore.instance.collection('hotel_Sharm');
  Future<void> addUser() {
    return hotel
        .doc(namehotel.text)
        .set({
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("AddHote_Sharm"),
      ),
