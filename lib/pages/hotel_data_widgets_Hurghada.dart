...
import 'package:store_app/pages/Edit_hotelHurghada.dart';
import 'package:store_app/pages/hotel_details.dart';
import 'package:store_app/pages/Add_price.dart';


class HohelDataHurghada extends StatelessWidget {
                  ...
                  Row(
                    children: [
                     ...
                     Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => EditdetailsHurghada(
                                        hotelname: hotelname.toString(),
                                        linkimg1: linkImg1.toString(),
                                        linkimg2: linkImg2.toString(),
                                        stars: stars.toString(),
