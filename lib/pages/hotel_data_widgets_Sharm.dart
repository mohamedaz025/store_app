...
import 'package:store_app/pages/Edit_hotelSharm.dart';
import 'package:store_app/pages/hotel_details.dart';
import 'package:store_app/pages/Add_price.dart';

class HohelDataSharm extends StatelessWidget {
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      IconButton(
                          onPressed: () {
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => EditdetailsSharm(
                                        hotelname: hotelname.toString(),
                      ...
                      IconButton(
                          onPressed: () {
                            CollectionReference deletehotel = FirebaseFirestore
                                .instance
                                .collection('hotel_Sharm');
